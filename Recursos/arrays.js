...
function ejMathSign(){
    signo = Math.sign(numeros);
    if (signo == 1) {
    document.getElementById('salida2').innerHTML = `Math.sign(numeros) = ${signo};`;
    document.getElementById('salida2b').innerHTML = `El número es positivo`;
    } else {
        document.getElementById('salida2').innerHTML = `Math.sign(numeros) = ${signo};`;
        document.getElementById('salida2b').innerHTML = `El número es negativo`;
    }
